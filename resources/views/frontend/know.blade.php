...
@section('content')
  ...
  <section class="px-6 py-16 bg-white">
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p class="text-[#4b3a42] text-lg leading-relaxed">
  ...
  <!-- Our Impact -->
  <section class="px-6 py-16 bg-[#fdf5f3]">
    <div class="max-w-5xl mx-auto">
      <h2 class="text-3xl font-bold text-center mb-10">What We’ve Accomplished</h2>
      <div class="grid md:grid-cols-3 gap-8 text-center">
        <div class="bg-white rounded-xl p-6 shadow border border-[#ebdbdb]">
          <h3 class="text-4xl font-extrabold text-[#44223C] mb-2">3,000+</h3>
          <p class="font-medium">Animals Rescued</p>
        </div>
        <div class="bg-white rounded-xl p-6 shadow border border-[#ebdbdb]">
          <h3 class="text-4xl font-extrabold text-[#44223C] mb-2">150+</h3>
          <p class="font-medium">Volunteers Involved</p>
        </div>
        <div class="bg-white rounded-xl p-6 shadow border border-[#ebdbdb]">
          <h3 class="text-4xl font-extrabold text-[#44223C] mb-2">80+</h3>
          <p class="font-medium">Permanent Adoptions</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="px-6 py-16 bg-white">
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        <h2 class="text-3xl font-bold mb-4">What We Stand For</h2>
        <ul class="list-disc pl-6 text-[#4b3a42] text-lg space-y-2">
  ...
  <!-- Quote Section -->
  <section class="bg-[#44223C] text-white px-6 py-24 text-center">
    <div class="max-w-3xl mx-auto">
  ...
  <!-- Call to Action -->
  <section class="bg-[#fceeea] px-6 py-20 text-center">
    <div class="max-w-3xl mx-auto">
      <h2 class="text-2xl sm:text-3xl font-bold mb-4">Ready to Get Involved?</h2>
      <p class="text-[#5e3c50] mb-6">
        Whether you volunteer, donate, or share — every action helps change a life. Join us in building a kinder world.
      </p>
      <a href="/volunteer" class="bg-[#44223C] text-white px-8 py-3 rounded-2xl text-lg hover:bg-[#5e2c51] transition">
        Become a Protector
      </a>
    </div>
  </section>
